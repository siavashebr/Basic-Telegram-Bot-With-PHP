...
class Telegram
{
    ...
    {
        //$url = 'http://botapi.hiteck.ir:8081/bot' . $this->bot_token . '/' . $api;
    ...
    {
        //$file_url = 'http://botapi.hiteck.ir:8081/file/bot' . $this->bot_token . '/' . $telegram_file_path;
    ...
    private function sendAPIRequest($url, array $content, $post = TRUE)
    {
        ...
        if ($this->log_errors) {
            if (class_exists('Logger')) {
                ...
                Logger::log(json_decode($result, TRUE), $loggerArray);
            }
        }
